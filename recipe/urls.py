...
urlpatterns = [
    ...
    path('<slug:slug>/ingredient/edit/<int:id>/', recipe_ingredient_edit, name='ingredient-edit'),
    path('<slug:slug>/ingredient/delete/<int:id>/', recipe_ingredient_delete, name='ingredient-delete')
